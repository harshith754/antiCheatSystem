...
const HomePage = (props: Props) => {
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex flex-row flex-1">
        <div className="border-primary  border-2 max-w-xs flex flex-col justify-between gap-2 shadow-md rounded-md">
          {/* Top scetion */}
        ...
        <div className="h-full flex flex-1 py-4 px-2 overflow-y-scroll">
      ...
      {loading && (
        <div className="z-50 absolute w-full h-full flex items-center justify-center bg-primary-foreground ">
          Getting things ready . . . <Rings height={50} />
        </div>
      )}
    </div>
  );
  ...
  function userPromptScreenshot() {
    ...
    if (!webcamRef.current) {
      ...
      // console.log(imgSrc); //base 64 image
  ...
  function userPromptRecord() {
    ...
    if (mediaRecorderRef.current?.state == "recording") {
      //check recording
      // stop recordng and save to download
      mediaRecorderRef.current.requestData(); //will trigger ondataavailable
